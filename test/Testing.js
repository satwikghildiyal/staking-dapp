...
describe('Staking', function() {
    ...
    describe('deploy', function () {
        ...
        it('sets up tiers and lock periods', async function() {
    ...
    describe('stakeEther', function() {
        ...
        it('adds address and positionId to positionIdByAddress', async function() {
    ...
    describe('modifyLockPeriods', function() {
        ...
        describe('non-owner', function() {
            ...
            it('revert', async function() {
                ...
                expect(staking.connect(signer2).modifyLockPeriods(100, 999)
    ...
    describe('getPositionIdsForAddress', function() {
        ...
        it('returns a list of  positionIds created by a specific address', async() => {
            ...
            expect(positionIds.map(p => Number(p))
            ).to.eql([0, 1])
    ...
    describe('changeUnlockDate', function() {
        ...
        describe('owner', function() {
            ...
            it('changes the unlockDate', async() => {
                ...
                expect(newPosition.unlockDate).to.be.equal(oldPosition.unlockDate - (86400 * 500))
        ...
        describe('non-owner', function() {
            ...
            it('reverts', async() => {
                ...
                expect(staking.connect(signer2).changeUnlockDate(0, newUnlockDate))
                .to.be.revertedWith('Only owner may modify unlock dates')
            })
    ...
    describe('closePosition', function() {
        ...
        describe('after unlock date', function() {
            ...
            it('tranfers principal and interest', async() => {
                ...
                expect(signerBalanceAfter).to.equal(signerBalanceBefore.sub(gasUsed).add(position.weiStaked).add(position.weiInterest))
        ...
        describe('before unlock date', function() {
            ...
            it('tranfers only principal', async() => {
                ...
                expect(signerBalanceAfter).to.equal(signerBalanceBefore.sub(gasUsed).add(position.weiStaked))
